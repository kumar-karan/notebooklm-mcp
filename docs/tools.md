...
- `ask_question`
  ...
  - Returns AI Studio's answer plus the follow-up reminder.
...
- `re_auth`
  ...
  - Use when AI Studio rate limit is reached (50 queries/day for free accounts).
...
- `remove_notebook` – Removes entries from the library (not the original AI Studio notebook).
